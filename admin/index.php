    ...
    <nav class="navbar  navbar-default ">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          <a class="navbar-brand" href="index.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>SMS</a>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
           ...
           <ul class="nav navbar-nav navbar-right">
            <li><a href="logout.php"><i class="fa fa-caret-square-o-right"></i> Welcome: User</a></li>
...
<div class="container-fluid">
  ...
  <footer class="footer-area">
     <p>Copyright &copy; 2020 Student Management System. All Rights Reserved</p>
  </footer>
